...
setup(
    ...
    packages=['pyNN', 'pyNN.nest', 'pyNN.neuron', 'pyNN.arbor',
              ...
              'pyNN.neuron.standardmodels', 'pyNN.arbor.standardmodels', 'pyNN.arbor.procedures',
              'pyNN.brian2.standardmodels', 'pyNN.utility', 'pyNN.nineml',
              'pyNN.serialization',
              # Arbor prototype
              'pyNN.arborproto', 'pyNN.arborproto.standardmodels', 'pyNN.arborproto.procedures',
              ],
