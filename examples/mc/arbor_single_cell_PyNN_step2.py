...
from pyNN.arbor.cells import build_cable_cell_parameters
...
ion_channels = {'na': sim.NaChannel(), 'kdr': sim.KdrChannel()}

cell_components = build_cable_cell_parameters(parameters, ion_channels)
...
plt.xlabel("t (ms)")
plt.ylabel("v (mV)")
plt.savefig("arbor_single_cell_PyNN_step2.png")
