	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 ExpISyn /home/andrew/dev/pyNN_trunk/src/hoc/i686/expisyn.mod\n");
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 _tsav = t; {
   state_discontinuity ( _cvode_ieq + 0, & i , i - k * _args[0] ) ;
   } }
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 31 in file expisyn.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
